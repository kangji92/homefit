...
const COMMUTE: Record<string, Record<string, number>> = {
  ...
  // 안양권 — 인덕원·과천 인접(4호선/1호선·GTX-C 인덕원 예정). mock 추정.
  pyeongchon: {
    gangnam: 45,
    pangyo: 30,
    yeouido: 45,
...
export const MOCK_COMPLEXES: readonly Complex[] = [
  ...
  },
  {
    ...
    metrics: { education: 78, infrastructure: 82, environment: 70, futurePotential: 72 },
    schoolNearby: true,
  },
  {
    id: "anyang-clforet",
  ...
  },
  {
    ...
    metrics: { education: 80, infrastructure: 78, environment: 78, futurePotential: 70 },
    schoolNearby: true,
  },
  {
    id: "gunpo-sejong",
  ...
  },
  {
    ...
    stationDistanceM: 900,
    commuteMinutes: COMMUTE.uiwang,
    metrics: { education: 80, infrastructure: 78, environment: 80, futurePotential: 78 },
    schoolNearby: true,
  },
  {
    id: "gamil-penterium",
