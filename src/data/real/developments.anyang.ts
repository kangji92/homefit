...
const EAST: DevelopmentArea = {
  ...
  certainty: "confirmed",
  regionId: "pyeongchon",
  // 공식 NSDI 정비구역 SHP(EPSG:5174→WGS84 변환)의 실제 경계. 면적 검증 일치(91,267㎡).
...
const NORTH: DevelopmentArea = {
  ...
  certainty: "confirmed",
  regionId: "pyeongchon",
  // 공식 NSDI 정비구역 SHP(EPSG:5174→WGS84)의 실제 경계. 면적 검증 일치(64,374㎡≈64,375.3).
  geometry: { kind: "polygon", rings: [NORTH_RING] },
  geometryAccuracy: "official_boundary",
  verification: "verified",
